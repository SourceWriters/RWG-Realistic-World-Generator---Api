...
public final class Versions {
    ...
    public static boolean isCompatible(int major, int minor) {
        return isCompatible(major, minor, 0);
    }

    public static boolean isCompatible(int major, int minor, int patch) {
        return getMinecraft().compareTo(new DefaultVersion(major, minor, patch)) >= 0;
    }

    public static boolean isCompatibleEx(int major, int minor) {
        return isCompatible(major, minor, 0);
    }

    public static boolean isCompatibleEx(int major, int minor, int patch) {
        return getMinecraft().compareTo(new DefaultVersion(major, minor, patch)) == 0;
    }

    public static boolean isServerCompat(int major, int minor) {
        return isServerCompat(major, minor);
    }

    public static boolean isServerCompat(int major, int minor, int refaction) {
        return getServer().compareTo(new ServerVersion(major, minor, 0, refaction)) >= 0;
    }

    public static boolean isServerCompatEx(int major, int minor) {
        return isServerCompat(major, minor);
    }

    public static boolean isServerCompatEx(int major, int minor, int refaction) {
        return getServer().compareTo(new ServerVersion(major, minor, 0, refaction)) == 0;
    }
