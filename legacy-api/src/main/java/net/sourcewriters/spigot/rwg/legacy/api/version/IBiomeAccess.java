...
public interface IBiomeAccess {
    ...
    default Biome getBiome(@NonNull BiomeGrid grid, int x, int z) {
        return getBiome(grid, x, 0, z);
    }

    default void setBiome(@NonNull BiomeGrid grid, int x, int z, Biome biome) {
        setBiome(grid, x, 0, z, biome);
    }

    default Biome getBiome(@NonNull World world, int x, int z) {
        return getBiome(world, x, 0, z);
    }

    default void setBiome(@NonNull World world, int x, int z, Biome biome) {
